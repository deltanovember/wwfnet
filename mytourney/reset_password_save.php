...
{ echo( "<font size='2' face='Verdana, Arial, Helvetica, sans-serif'>Your changes have been made sucessfully.<br><br><a href='http://wordswithfriends.net/?page_id=386'>Back to Login</a></font>  " );
}
else
{
