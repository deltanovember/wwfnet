  ...
  <form action="edit_profile_save.php" method="post" name="form" id="form">
    ...
    <tr>
      ...
      <td>
        ...
        <option <?php if ($device=="iPhone") {echo "selected";} ?> value="iPhone">iPhone</option><option <?php if ($device=="iPod Touch") {echo "selected";} ?> value="iPod Touch">iPod Touch</option><option <?php if ($device=="iPad") {echo "selected";} ?> value="iPad">iPad</option><option <?php if ($device=="Android") {echo "selected";} ?> value="Android">Android</option></select></td>
    </tr>
