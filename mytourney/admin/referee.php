...
$p1_g2 = "";
if (isset ($row["r" . $onround . "_g2"])) {
 $p1_g2= $row["r" . $onround . "_g2"];
}
$p1_g3 = "";
if (isset ($row["r" . $onround . "_g3"])) {
...
<?php
if ($status == "Eliminated") { echo "<span style='color:red; font-weight:bold'>" . $status . "</span> in Round " . $lastround . "<br /><a href='change_status.php?t_id=$t_id&id=$id&action=reinstate'><img src='$base_dir/images/green_arrow_up.png' border='0px' /></a> Resurrect into Round " . $t_round . "?";}
...
<span style="font-size:170%; font-weight:bold;">Round <?php echo $onround ?></span><br />
...
// get results
$result = mysql_query($query) or die("Couldn't execute queryc");
...
<form action="referee.php?t_id=<?php echo $t_id; ?>&id=<?php echo $id ?>&round=<?php echo $onround ?>" method="post" name="form" id="form">
...
<tr valign="top"><td colspan="2" align="right"><p><b>Winner of Round <?php echo $onround; ?>:</b></p></td><td><p>
...
<tr valign="top"><td colspan="2" align="right"><p><b>Round <?php echo $onround; ?> outcome:</b></p></td><td><p><select name="result" >
...
<tr valign="top"><td colspan="2" align="right"><p><b><?php echo $player . " rated " . $opponent ?> as:<br /></b></p></td><td><p><select name="rating" >
  <option value="">--Make Selection--</option>
