...
if ($prev_round > 0) { echo "<a href='manage_daily_twoback.php?t_id=" . $t_id . "&id=" . $id . "&action=recordscores'>< Update Previous Round</a><br /><br />"; }
?>

<?php
echo "<a href='manage_daily.php?t_id=" . $t_id . "&id=" . $id . "&action=recordscores'>Return to Current Round ></a>"; 
?>
</td></tr>
</table>
...
<table width="500px" border="0" cellspacing="0" cellpadding="0" style="padding: 10px; border: 1px solid #CCC;">
    <form action="manage_daily_prior.php?t_id=<?php echo $t_id; ?>&id=<?php echo $id ?>" method="post" name="form" id="form">
...
<tr><td colspan="2" style="font-weight:bold;"><?php echo $player; ?></td><td style="font-weight:bold;"><?php echo $opponent; ?></td></tr>
<tr>
<td colspan="2"><input type = "text" value="<?php echo $p1_g1; ?>" name="p1_g1" size="3" /></td>
<td><input type = "text" value="<?php echo $p2_g1; ?>" name="p2_g1" size="3" /></td>
</tr>
